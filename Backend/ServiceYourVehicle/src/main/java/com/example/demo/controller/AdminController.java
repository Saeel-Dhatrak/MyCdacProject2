...
public class AdminController {
	...
	public ResponseEntity<?> updateCustomer(@PathVariable String customerId,@RequestBody Customer oldDetails)
	{
		System.out.println("inside updating the customer"+customerId);
		try {
			Customer updatingDetails=customerService.updateCustomerDetail(Integer.parseInt(customerId), oldDetails);
			return new ResponseEntity<>(updatingDetails, HttpStatus.OK);
		}catch(RuntimeException e)
		{
			e.printStackTrace();
